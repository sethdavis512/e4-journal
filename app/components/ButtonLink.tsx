...
import { ButtonProps } from '@lemonsqueezy/wedges';
...
const buttonLinkVariants = cva({
    ...
    compoundVariants: [
        ...
        },
        {
            ...
            destructive: true,
            class: 'bg-destructive text-white outline-destructive hover:bg-destructive-600 disabled:bg-destructive disabled:opacity-50 dark:text-white dark:hover:bg-destructive-600 dark:disabled:text-white'
        },
        {
            variant: 'tertiary',
            destructive: true,
            class: 'bg-destructive-50 hover:bg-destructive-100 disabled:bg-destructive-50 dark:bg-surface dark:hover:bg-surface-200'
        },
        {
            variant: 'transparent',
            destructive: true,
        ...
        },
        {
            variant: 'outline',
            destructive: true,
            class: 'border-destructive hover:bg-destructive-50 disabled:border-destructive-100 dark:border-destructive dark:hover:bg-surface dark:disabled:border-destructive-900'
        },
        {
            variant: 'link',
            destructive: true,
            class: 'hover:text-destructive-800 focus-visible:text-destructive-800 dark:hover:text-destructive-400 dark:focus-visible:text-destructive-400'
        },
        ...
        },
        {
            variant: ['outline', 'tertiary', 'transparent', 'link'],
            destructive: true,
            class: 'text-destructive-700 outline-destructive disabled:text-destructive-300 dark:text-destructive-500 dark:disabled:text-destructive/50'
        }
    ],
    defaultVariants: {
        shape: 'rounded',
...
export default function ButtonLink({ children, to, variant }: ButtonLinkProps) {
    return (
        <Link className={cn(buttonLinkVariants({ variant }))} to={to}>
            {children}
        </Link>
    );
}
